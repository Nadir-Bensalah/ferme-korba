export const fr = {
  ...
  home: {
    ...
    deals: {
      eyebrow: 'Nos offres',
      title: 'Des produits frais à prix doux',
      text: 'Chaque semaine, découvrez nos meilleures offres directement de la ferme.',
      noteLeft: 'Des produits frais, chaque semaine !',
      noteRight: 'Le bon goût du local !',
      ...
      trust: [
        ...
        ['Produits 100 % locaux', 'Directement de la ferme'],
        ['Soutien aux éleveurs', 'Une agriculture responsable'],
      ],
    },
    ...
    heroTitleLead: 'Le poulet fermier,',
    heroTitleAccent: 'comme avant.',
    heroBadges: [
      { title: 'Élevage', text: 'en plein air' },
      { title: 'Nourri au grain', text: 'de la région' },
      { title: 'Abattu', text: 'le matin même' },
      { title: 'Livraison', text: 'dans tout le Cap Bon' },
    ],
  ...
  cart: {
    ...
    countIn: (n: number) => (n === 1 ? '1 article dans votre panier' : `${n} articles dans votre panier`),
    cutoffTitle: (hour: string) => `Heure limite aujourd’hui : ${hour}`,
    cutoffText: (day: string) => `Commandez maintenant pour une livraison ${day}.`,
    cutoffPastTitle: 'Heure limite passée pour aujourd’hui',
    chips: {
      'volailles-entieres': ['100 % naturel', 'Élevage local'],
      decoupes: ['100 % naturel', 'Élevage local'],
      dinde: ['100 % naturel', 'Élevage local'],
      oeufs: ['Œufs extra frais', 'Sans OGM'],
      charcuterie: ['Fait maison', 'Sans conservateur'],
      marines: ['Prêt à cuire', 'Recette maison'],
    } as Record<string, [string, string]>,
    freshNote: 'Des produits frais, du jour, directement de notre ferme à votre table.',
    seeShop: 'Voir toute la boutique',
    subtotalItems: (n: number) => (n === 1 ? 'Sous-total (1 article)' : `Sous-total (${n} articles)`),
    freeLabel: 'Gratuite',
    freeSavedLong: (amount: string) => `Vous économisez ${amount} de frais de livraison.`,
    codTitle: 'Paiement à la livraison',
    codText: 'Aucun paiement en ligne',
    secureTitle: 'Commande',
    secureText: '100 % sécurisée',
    happyAlt: 'Des produits locaux pour une vie meilleure !',
    drawerSub: 'Produits frais de notre ferme',
    addNote: 'Ajouter une note à ma commande',
    freeMissingShort: (amount: string) => `Encore ${amount} pour en profiter`,
    drawerTrust: ['Produits frais', 'Paiement sécurisé', 'Livraison rapide'],
    stickyLabel: 'Résumé du panier',
    progressLabel: 'Progression vers la livraison offerte',
    viewCart: 'Voir le panier',
    emptyText: 'Choisissez vos produits, on vous livre à la maison.',
  ...
  footer: {
    pillars: [
      { title: 'Produits', text: 'locaux' },
      { title: 'Qualité', text: 'garantie' },
      { title: 'Livraison', text: 'rapide' },
      { title: 'Soutien aux', text: 'producteurs' },
    ],
    taglineAlt: 'Le goût du local',
    happyEggsAlt: 'Des œufs heureux pour une vie meilleure !',
    signAlt: 'Direct de la ferme',
    whatsappCta: 'Nous écrire sur WhatsApp',
    newsletter: 'Newsletter',
    newsletterText: 'Recevez nos nouveautés, recettes et offres spéciales !',
    emailPlaceholder: 'Votre email',
    subscribe: 'S’inscrire',
    subscribed: 'C’est noté, à bientôt dans votre boîte mail.',
    subscribeError: 'Entrez une adresse e-mail valide.',
    subscribeFail: 'L’inscription n’a pas abouti. Réessayez dans un instant.',
    values: ['Produits tunisiens', 'Fraîcheur', 'Authenticité', 'Le goût du local'],
